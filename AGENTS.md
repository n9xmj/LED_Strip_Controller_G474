...
- **Active plan:** [`Docs/planning/play-v1-implementation-plan.md`](Docs/planning/play-v1-implementation-plan.md) → user docs [`Docs/Player/README.md`](Docs/Player/README.md) · legacy notebook [`Docs/PLAY_language_design.md`](Docs/PLAY_language_design.md). **Session target:** v1 + v1.1 PLAY firmware **complete** on G474; optional **G11** [`uart_stream`](Docs/planning/uart_stream-port-notes.md); doc Phase 2 (**T4** EBNF + **T5** howto in `Docs/Player/`); post-v1 → **vTree+ Mk 5** mic/DSP ([PROJECT.md](Docs/PROJECT.md)).
