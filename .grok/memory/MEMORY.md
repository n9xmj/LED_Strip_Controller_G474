...
- [Session handoff 2026-06-21 — line editor + bounded fields](session-handoff-2026-06-21-line-editor.md) — `x_term_getline_editor`, S11 field window, Tab form nav, HuIL `[l]`/`[f]`; next: W7 polish, wire into real forms
