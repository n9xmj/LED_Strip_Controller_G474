...
void MX_LPUART1_UART_Init(void)
{
  ...
  hlpuart1.Init.BaudRate = 2400000;
  ...
  hlpuart1.AdvancedInit.AdvFeatureInit = UART_ADVFEATURE_TXINVERT_INIT;
...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  */
    ...
    PC1     ------> LPUART1_TX
    */
    GPIO_InitStruct.Pin = LED_STRIP_2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_OD;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF8_LPUART1;
    HAL_GPIO_Init(LED_STRIP_2_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE BEGIN LPUART1_MspInit 1 */
    ...
    // Force LED_STRIP_2 pin to use push-pull drive
    // CubeMX does not allow this setting, so it is forced here
//    GPIO_InitStruct.Pin = LED_STRIP_2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP; // Formerly GPIO_MODE_AF_OD;
//    GPIO_InitStruct.Pull = GPIO_PULLUP;
//    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
//    GPIO_InitStruct.Alternate = GPIO_AF8_LPUART1;
    HAL_GPIO_Init(LED_STRIP_2_GPIO_Port, &GPIO_InitStruct);
  ...
  */
    ...
    PC10     ------> UART4_TX
    */
    GPIO_InitStruct.Pin = LED_STRIP_4_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF5_UART4;
    HAL_GPIO_Init(LED_STRIP_4_GPIO_Port, &GPIO_InitStruct);

    /* UART4 DMA Init */
    /* UART4_TX Init */
    hdma_uart4_tx.Instance = DMA1_Channel5;
  ...
  */
    ...
    PC12     ------> UART5_TX
    */
    GPIO_InitStruct.Pin = LED_STRIP_5__UART5__Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF5_UART5;
    HAL_GPIO_Init(LED_STRIP_5__UART5__GPIO_Port, &GPIO_InitStruct);

    /* UART5 DMA Init */
    /* UART5_TX Init */
    hdma_uart5_tx.Instance = DMA1_Channel6;
  ...
  */
    ...
    */
    ...
    HAL_GPIO_Init(LED_STRIP_3_GPIO_Port, &GPIO_InitStruct);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END LPUART1_MspDeInit 0 */
    ...
    PC1     ------> LPUART1_TX
    */
    HAL_GPIO_DeInit(LED_STRIP_2_GPIO_Port, LED_STRIP_2_Pin);
  ...
  /* USER CODE END UART4_MspDeInit 0 */
    ...
    PC10     ------> UART4_TX
    */
    HAL_GPIO_DeInit(LED_STRIP_4_GPIO_Port, LED_STRIP_4_Pin);
  ...
  /* USER CODE END UART5_MspDeInit 0 */
    ...
    PC12     ------> UART5_TX
    */
    HAL_GPIO_DeInit(LED_STRIP_5__UART5__GPIO_Port, LED_STRIP_5__UART5__Pin);
  ...
  /* USER CODE END USART1_MspDeInit 0 */
    ...
    PC4     ------> USART1_TX
    */
    HAL_GPIO_DeInit(LED_STRIP_1_GPIO_Port, LED_STRIP_1_Pin);
