...
*Last audited: 2026-06-28 (**G1–G6 + G11 HIL-validated on hardware** via `scripts/spiflash_bench.py` —
34 checks: 12 driver + 22 partition, all green; G12 in progress; G7–G10 pending).*
