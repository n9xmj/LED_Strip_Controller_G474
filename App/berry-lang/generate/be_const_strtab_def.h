be_define_const_str(, "", 2166136261u, 0, 0, &be_const_str_classname);
be_define_const_str(_X21_X3D, "!=", 2428715011u, 0, 2, &be_const_str_isreadonly);
...
be_define_const_str(__lower__, "__lower__", 123855590u, 0, 9, &be_const_str_time);
...
be_define_const_str(_change_buffer, "_change_buffer", 2101848693u, 0, 14, &be_const_str_inf);
...
be_define_const_str(addfloat, "addfloat", 937731078u, 0, 8, &be_const_str_atan);
...
be_define_const_str(append, "append", 110723809u, 0, 6, &be_const_str_if);
be_define_const_str(appendb64, "appendb64", 277140235u, 0, 9, &be_const_str_assert);
be_define_const_str(appendhex, "appendhex", 3568017334u, 0, 9, &be_const_str_solidified);
be_define_const_str(as, "as", 1579491469u, 69, 2, &be_const_str_getfloat);
...
be_define_const_str(break, "break", 3378807160u, 60, 5, &be_const_str_ismethod);
...
be_define_const_str(class, "class", 2872970239u, 59, 5, &be_const_str_rand);
...
be_define_const_str(compact, "compact", 2705491686u, 0, 7, NULL);
...
be_define_const_str(continue, "continue", 2977070660u, 61, 8, &be_const_str_format);
...
be_define_const_str(def, "def", 3310976652u, 57, 3, &be_const_str_floor);
...
be_define_const_str(do, "do", 1646057492u, 67, 2, NULL);
be_define_const_str(dump, "dump", 3663001223u, 0, 4, &be_const_str_min);
be_define_const_str(elif, "elif", 3232090307u, 53, 4, NULL);
be_define_const_str(else, "else", 3183434736u, 54, 4, &be_const_str_except);
be_define_const_str(end, "end", 1787721130u, 58, 3, &be_const_str_static);
be_define_const_str(endswith, "endswith", 790464931u, 0, 8, &be_const_str_replace);
be_define_const_str(escape, "escape", 2652972038u, 0, 6, &be_const_str_setfloat);
be_define_const_str(except, "except", 950914032u, 71, 6, &be_const_str_imin);
...
be_define_const_str(get, "get", 1410115415u, 0, 3, &be_const_str_max);
be_define_const_str(getbits, "getbits", 3094168979u, 0, 7, &be_const_str_hex);
be_define_const_str(getfloat, "getfloat", 2820979603u, 0, 8, &be_const_str_startswith);
...
be_define_const_str(if, "if", 959999494u, 52, 2, &be_const_str_tr);
...
be_define_const_str(import, "import", 288002260u, 68, 6, &be_const_str_rad);
be_define_const_str(incr, "incr", 482404207u, 0, 4, &be_const_str_item);
be_define_const_str(inf, "inf", 2749994088u, 0, 3, &be_const_str_init);
...
be_define_const_str(isinf, "isinf", 648810968u, 0, 5, &be_const_str_keys);
...
be_define_const_str(nil, "nil", 228849900u, 65, 3, NULL);
be_define_const_str(nocompact, "nocompact", 3121137167u, 0, 9, &be_const_str_srand);
...
be_define_const_str(raise, "raise", 1593437475u, 72, 5, &be_const_str_split);
...
be_define_const_str(return, "return", 2246981567u, 62, 6, &be_const_str_upvname);
...
be_define_const_str(startswith, "startswith", 4221853948u, 0, 10, &be_const_str_while);
...
static const bstring* const m_string_table[] = {
    ...
    (const bstring *)&be_const_str_endswith,
    ...
    NULL,
    (const bstring *)&be_const_str_round,
