...
// Provide a pointer param in each job queue member
// Setting this will increase the memory required to contain the job queue by 2x
#ifndef JOB_QUEUE_PROVIDE_POINTER_PARAM
#define JOB_QUEUE_PROVIDE_POINTER_PARAM     1
#endif
...
#define DEFAULT_JOB_QUEUE_SIZE          0
...
extern void v_job_add_with_pointer(job_queue_t *p_x_queue, uint8_t u8_job_id, uint8_t u8_param1, uint16_t u16_param2, void *p_v_pointer);
extern uint8_t u8_job_get(job_queue_t *p_x_queue, job_t *p_x_job);
extern void v_job_queue_clear(job_queue_t *p_x_queue);
extern bool b_job_queue_empty(job_queue_t *p_x_queue);
